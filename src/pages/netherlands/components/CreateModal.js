...
import { Modal, Button, Form, Input, message, Icon, Select, Checkbox, DatePicker, LocaleProvider, Upload, Col   } from 'antd';
...
const formItemLayout = {
  ...
  const { houseId, treeShow, houseName,  previewSrc,previewShow ,houseList } = Netherlands
  // console.log(listDat)
      ...
      >
        <Form>
                ...
                <LocaleProvider locale={zh_CN}> 
                 {
                  getFieldDecorator('time', {
                    ...
                    initialValue: [ moment(editData.startDate), moment(editData.endDate)] || [],
            ...
            <FormItem label={'身份类型'} {...formItemLayout}>
              {
                getFieldDecorator('identityTypes', {
                  rules: [{
                    required: true,
                    message: '请输入身份类型',
                  }],
                  initialValue: editData.identityTypes?editData.identityTypes.split(','):'' ||  ['1', '2', '3', '5'],
                })( 
                   <CheckboxGroup options={Netherlands.typeCheck}  onChange={onChange} />
                )
              }
            </FormItem>
            <div id="offerType">
            <FormItem label={'优惠类型'} {...formItemLayout} >
              {
                ...
                initialValue: editData.discountType || '1',
              })(
                <Select placeholder = "请选择"
                  showSearch
                  getPopupContainer={() => document.getElementById('offerType')}
                >
            ...
            {
              editData.houseName ?  <span>{editData.houseName}</span>  : null
            } 
            &nbsp;
            {
            ...
            <FormItem label={'图片'} {...formItemLayout} >
              <div onClick={(e) => { openFileUpload(e,dispatch,'Netherlands') }}>
              {
