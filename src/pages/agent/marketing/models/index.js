...
import { userInvitePage, userInviteExport, productShowcaseList} from '../../services'

export default modelExtend(
  filterModel({ reqFn: userInvitePage, namespace: 'marketing',downloadFn : userInviteExport}),
{
  namespace: 'marketing',
  state: {
    statusList: [
  ...
  subscriptions: {
    setup({
      ...
      history.listen(location => {
        if (location.pathname === '/agent/marketing') {
          dispatch({
            type: 'getPageList',
            payload: {},
          })
