...
@connect(({ detailActivity, loading, app }) => ({ detailActivity, loading, app }))
...
class Create extends PureComponent {
  ...
  render() {
    const { detailActivity, visible } = this.props
    const { treeList } = detailActivity;
    ...
    //   if (e.checked){
    //     this.setState({
    //       houseName: e.checkedNodes[0].props.name,
    //     });
    //   }
    //   this.setState({
    //     checkedKeys,
